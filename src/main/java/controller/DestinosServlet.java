...
public class DestinosServlet extends HttpServlet {
		...
		throws IOException, ServletException
	{
		...
		db.add(new Destinos(2, "O Negócio", "São Paulo", "Brasil", "BRL", "Avião", "./assets/images/sp.jpg", "./assets/images/la.jpg", "https://www.youtube.com/embed/Jmn8pLnNvF0", "220 Volts", "RG", "Short Description"));
		...
		if (result != null) {
			...
			pageRedirect = "/destinos-list.jsp";
		}
